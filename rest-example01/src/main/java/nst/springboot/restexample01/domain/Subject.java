...
public class Subject implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return esbp == subject.esbp && Objects.equals(id, subject.id) && Objects.equals(name, subject.name) && Objects.equals(department, subject.department);
    }
    @Override
    public int hashCode() {
        return Objects.hash(id, name, esbp, department);
    }
}
